...
public class DateTimeUtilities {
    ...
    /**
     * This method returns difference btw end and start time
     * @param start time
     * @param end time
    ...
    public static long getTimeDifference(String start, String end, String format){
        LocalTime startTime = LocalTime.parse(start, DateTimeFormatter.ofPattern(format));  //parsing the time, means converting one type to other
